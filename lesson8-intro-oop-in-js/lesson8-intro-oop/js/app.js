...
console.log(`Street is ${address.street}`); // North 4th Street        //console.log("Street is " + address.street)
console.log(`House Number is ${address["house number"]}`);//1000
...
const anna = {
    ...
    printFullName: function() {
        console.log(`${this.firstName} ${this.lastName}`);//Anna Smith
    } 
};
